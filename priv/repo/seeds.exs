...
#
#     LiveMyStudio.Repo.insert!(%LiveMyStudio.SomeSchema{})
#
# We recommend using the bang functions (`insert!`, `update!`
# and so on) as they will fail if something goes wrong.

alias LiveMyStudio.Repo
alias LiveMyStudio.Boats.Boat
alias LiveMyStudio.Stores.Store
alias LiveMyStudio.Servers.Server
alias LiveMyStudio.Donations.Donation
alias LiveMyStudio.PizzaOrders.PizzaOrder
alias LiveMyStudio.GitRepos.GitRepo
alias LiveMyStudio.Vehicles.Vehicle
alias LiveMyStudio.Incidents.Incident
alias LiveMyStudio.Geo
