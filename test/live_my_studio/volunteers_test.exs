defmodule LiveMyStudio.VolunteersTest do
  use LiveMyStudio.DataCase

  alias LiveMyStudio.Volunteers

  describe "volunteers" do
    alias LiveMyStudio.Volunteers.Volunteer

    @valid_attrs %{checked_out: true, name: "some name", phone: "303-555-1010"}
    @update_attrs %{checked_out: false, name: "some updated name", phone: "303-505-1010"}
    ...
    test "create_volunteer/1 with valid data creates a volunteer" do
      ...
      assert volunteer.phone == "303-555-1010"
    end
    ...
    test "update_volunteer/2 with valid data updates the volunteer" do
      ...
      assert volunteer.phone == "303-505-1010"
    end
